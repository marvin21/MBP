...
def main(argv):
   ...
   for param in paramArray:
      if not ('name' in param and 'value' in param):
          ...
          measureInterval = param["value"]
      elif param["name"] == "noisy_data":
         noisy_data = param["value"]
         print(noisy_data)
   ...
   try:
      while True:
         ...
         msg_pub = {"component": component.upper(), "id": component_id, "value": "(" + str(x) + "," + str(y) +")", "noisyData": noisy_data}
